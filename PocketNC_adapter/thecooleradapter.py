        ...
        while True:
            try:
                ...
                if self.power.value() == 'ON':
                    ...
                    if (ex == 'ACTIVE' or ex == 'STOPPED' or ex == 'INTERRUPTED' or float(
                            self.Srpm.value()) > 0) and estop == 'ARMED':
                ...
                if ylt2 != 'initialize' and self.power.value() == 'ON' and ylt1 != ylt2:
                    ...
                    if ct2 != 'initialize' and ex == 'ACTIVE' and self.Srpm.value() != None and float(
                            self.Srpm.value()) > 0 and self.estop.value() == 'ARMED':
                    ...
                    if (at2 != 'initialize' and ex == 'ACTIVE' or ex == 'INTERRUPTED' or ex == 'STOPPED' or float(
                            self.Srpm.value()) > 0) and self.estop.value() == 'ARMED':
...
if __name__ == "__main__":
    print("Starting Up...")
    pocketNcadapter = pocketNCAdapter('localhost', 5001)
